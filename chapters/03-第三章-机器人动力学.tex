...
这个方程表明，当$r_i$很小时，$r_i^2 m_{ii}$远小于$J_{Mi}$的情形下，主对角线由电机惯量$J_{Mi}$主导，机械臂动力学可近似看作$n$个具有常数系数的解耦二阶方程；关节耦合与重力等进入$d_i$，表现为耦合扰动项。也就是说，在强减速、小$r_i$时若连杆项相对反射电机惯量可忽略，控制设计往往以执行器主导的关节动态为出发点。
