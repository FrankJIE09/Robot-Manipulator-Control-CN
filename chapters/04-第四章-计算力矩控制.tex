...
\left\{
\begin{aligned}
        a_{i0} &= q_{ik}, & a_{i1} &= 0, & a_{i2} &= v_i/(2t_b) \\
...
\begin{equation}
    u_k = k_p e_k + \frac{k_p T}{T_I} \sum_{i=0}^{k} e_i
\end{equation}
...
\begin{equation}
    u_k = u_{k-1} + k_p(e_k - e_{k-1}) + \frac{k_p T}{T_I} e_k
\end{equation}
...
\begin{equation}
    u_k = u_{k-1} + k_p(e_k - e_{k-1}) + \frac{k_p T}{T_I} e_k + (u_{k-1} - u_{k-1}^{sat})
\end{equation}
